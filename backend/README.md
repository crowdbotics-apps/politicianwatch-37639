...
## Project Structure
    ...
    ├── politicianwatch_37639  # Django project configurations
...
1. Clone this repo and `cd politicianwatch_37639`
...
2. Clone this repo and `cd politicianwatch_37639`
